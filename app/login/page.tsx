      ...
      <div className="glass rounded-2xl sm:rounded-3xl border border-white/10 p-6 sm:p-8 md:p-10 max-w-md w-full">
        <div className="space-y-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 rounded-lg border border-white/10 bg-black/50 px-4 py-3 text-white hover:border-cyan-neon/50 hover:bg-black/70 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
